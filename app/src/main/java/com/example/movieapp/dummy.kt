...
class BadCodeExample {
    ...
    // Deprecated function (bad practice)
    @Deprecated("Use calculateDiscount instead", ReplaceWith("calculateDiscount(price)"))
    fun oldCalculate(price: Double): Double {
        return price - (price * 0.10) // Old discount logic
    }
